...
bool TestNode::show_help(std::string command) {
  td::TerminalIO::out()
      << "\tList of available commands:\n"
         "\n"
         "\t\033[32;1;228mtime                                    \033[37;1;228mGet server time\n"
         "\t\033[32;1;228mlast                                    \033[37;1;228mGet last block and state info from server\n"
         "\t\033[32;1;228msendfile        \033[34;1;228m<filename>              \033[37;1;228mLoad a serialized message from <filename> and"
         " send it to server\n"
         "\t\033[32;1;228mstatus                                  \033[37;1;228mShow connection and local database status\n"
         "\t\033[32;1;228mgetaccount      \033[34;1;228m<addr> [<block-id-ext>] \033[37;1;228mLoads the most recent state of specified account;"
         " <addr> is in [<workchain>:]<hex-or-base64-addr> format\n"
         "\t\033[32;1;228mallshards       \033[34;1;228m[<block-id-ext>]        \033[37;1;228mShows shard configuration from the most recent"
         " masterchain state or from masterchain state corresponding to <block-id-ext>\n"
         "\t\033[32;1;228mgethead         \033[34;1;228m<block-id-ext>          \033[37;1;228mShows block header for <block-id-ext>\n"
         "\t\033[32;1;228mgetblock        \033[34;1;228m<block-id-ext>          \033[37;1;228mDownloads block\n"
         "\t\033[32;1;228mdumpblock       \033[34;1;228m<block-id-ext>          \033[37;1;228mDownloads and dumps specified block\n"
         "\t\033[32;1;228mgetstate        \033[34;1;228m<block-id-ext>          \033[37;1;228mDownloads state corresponding to specified block\n"
         "\t\033[32;1;228mdumpstate       \033[34;1;228m<block-id-ext>          \033[37;1;228mDownloads and dumps state corresponding to"
         " specified block\n"
         "\t\033[32;1;228mdumptrans       \033[34;1;228m<block-id-ext> <account-id> <trans-lt>\n"
         "\t                                        \033[37;1;228mDumps one transaction of specified account\n"
         "\t\033[32;1;228mlasttrans[dump] \033[34;1;228m<account-id> <trans-lt> <trans-hash> [<count>]\n"
         "\t                                        \033[37;1;228mShows or dumps specified transaction and several preceding ones\n"
         "\t\033[32;1;228mknown                                   \033[37;1;228mShows the list of all known block ids\n"
         "\t\033[32;1;228mprivkey         \033[34;1;228m<filename>              \033[37;1;228mLoads a private key from file\n"
         "\t\033[32;1;228mhelp            \033[34;1;228m[<command>]             \033[37;1;228mThis help\n"
         "\t\033[32;1;228mquit                                    \033[37;1;228mExit\n\033[30;0;228m";
  return true;
}
